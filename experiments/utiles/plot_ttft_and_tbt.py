...
with open('/work/nvme/bdkz/yyu69/vllm/experiment_results/chunk_size_experiment_20250423_023236/Qwen2.5-14B-Instruct/chunk_size_results_Qwen2.5-14B-Instruct.json', 'r') as f:
...
models = [
    ...
    },
    {
        ...
        "data": data_14b,
        "save_dir": "/work/nvme/bdkz/yyu69/vllm/experiment_results/chunk_size_experiment_20250423_023236/Qwen2.5-14B-Instruct"
    }
]
...
for model in models:
    ...
    ttft = [model_data["avg_prompt_tokens_1274"][f"chunk_size_{cs}"]["avg_prefill_time"] for cs in chunk_sizes]
    
    # TBT data (avg_time_between_tokens)
    tbt = [model_data["avg_prompt_tokens_1274"][f"chunk_size_{cs}"]["avg_time_between_tokens"] for cs in chunk_sizes]
    ...
    line = plt.plot(x_positions, ttft, 'o-', color='blue', linewidth=2, markersize=8, label='Prompt 1 (1274 tokens)')
